	...
	<section id="container">
		...
		<table>
			...
			<?php 
                ...
                //paginador
                $sql_register = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM obras WHERE estatus=1");
			...
			?>
                        <tr>
                            ...
                            <td>
                                ...
                                |
                                <a  class="link_eliminar" href="eliminar_confirmar_proyecto.php?id=<?php echo $data["id_proyecto"]; ?>"><i class="fas fa-trash"></i> Eliminar</a>
                            </td>
                        </tr>
			<?php
					}
