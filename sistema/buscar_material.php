    ...
    ?>
		...
		<table>
			...
			<?php 
                ...
                $sql_registrar = mysqli_query($conection,"SELECT COUNT(*) as total_registro, u.descripcion, ti.descripcion_tipo_insumo, f.familia, p.razon_social
															FROM materiales m
                                                            ...
                                                            WHERE (codigo_material LIKE '%$busqueda%' or
                                                                   descripcion_material LIKE '%$busqueda%' or
																   ti.descripcion_tipo_insumo LIKE '%$busqueda%' or
																   u.descripcion LIKE '%$busqueda%' or
																   f.familia LIKE '%$busqueda%' or
																   p.razon_social LIKE '%$busqueda%' or
																   costo_material LIKE '%$busqueda%')
															AND m.estatus=1
											")or die(mysqli_error());
