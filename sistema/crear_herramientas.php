...
<section id="container">
    <div class="form_register">
        ...
        <form action="" method="post" name="miForm">
            <div class="divisor_resp">
                ...
                <input type="text" name="codigo" id="codigo" maxlength="30" required
                    ...
                    echo "autofocus";
                       ...
                       value="<?php if (isset($herramientas) && isset($code) && $code !== 1 && $code !== 8) echo $herramientas ?>"/>
            </div>
            ...
            <button type="submit" name="btn-signup" class="btn_save"><i class="fas fa-plus-circle"></i> Crear
                herramientas
            </button>
        </form>
    </div>
...
if (isset($code) && $code == 9) {
    ...
    <section id="container" style="padding: 0">
        <br>
        <h1><i class="fas fa-id-card fa-lg"></i> Lista de Herramienta</h1>
        ...
        <table>
            ...
            $query = mysqli_query($conection, "SELECT m.*, u.descripcion, ti.descripcion_tipo_insumo
				...
				WHERE m.estatus=1
				ORDER BY codigo_herramienta DESC LIMIT $desde,$por_pagina");
            ...
            if ($result > 0) {
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="link_edit"
                               href="editar_herramientas.php?id=<?php echo $data["codigo_herramienta"]; ?>"><i
                                        class="fas fa-user-edit"></i> Editar</a>
                            |
                            <a class="link_eliminar"
                               href="eliminar_confirmar_herramientas.php?id=<?php echo $data["codigo_herramienta"]; ?>"><i
        ...
        <div class="paginador">
            <ul>
                <li><a href="herramientas.php" title="Volver al Listado de Herramienta"><i
