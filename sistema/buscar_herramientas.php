...
<body>
    ...
    ?>
		...
		<br>
		<h1>herramientas</h1>
        <a href="crear_herramientas.php" class="btn_new"><i class="fas fa-plus-circle"></i> Nueva herramientas</a>
		...
		<table>
			...
			<?php 
                ...
                $sql_registrar = mysqli_query($conection,"SELECT COUNT(*) as total_registro, u.descripcion, ti.descripcion_tipo_insumo
                                                            ...
                                                            WHERE (codigo_herramienta LIKE '%$busqueda%' or
                                                                   descripcion_herramienta LIKE '%$busqueda%' or
																   ti.descripcion_tipo_insumo LIKE '%$busqueda%' or
																   u.descripcion LIKE '%$busqueda%' or
																   costo_herramienta LIKE '%$busqueda%')
															AND m.estatus=1
											")or die(mysqli_error());
