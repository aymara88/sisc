            ...
            ?>
				<form action="" method="post" name="miForm">
					<div class="divisor_resp">
						...
						<input type="text" name="codigo" id="codigo" value="<?php echo $resultm['codigo_herramienta'] ?>" maxlength="30" required title="Introduzca sólo letras o números. Tamaño mínimo: 2. Tamaño máximo: 30" autofocus onchange="javascript:this.value=this.value.toUpperCase();" <?php if(isset($code) && $code == 1){ echo "autofocus"; } ?> />
					</div>
					<div class="divisor_resp">
						<label for="descripcion">Descripción</label>
						<input type="text" name="descripcion" id="descripcion" value="<?php echo $resultm['descripcion_herramienta'] ?>" maxlength="100" required title="Introduzca sólo letras o números. Tamaño mínimo: 2. Tamaño máximo: 100" onchange="javascript:this.value=this.value.toUpperCase();" <?php if(isset($code) && $code == 2){ echo "autofocus"; } ?> />
					</div>
					<div class="divisor_resp">
					...
					<div class="divisor_resp">
						...
						<input type="text" name="costo" id="costo" value="<?php echo $resultm['costo_herramienta'] ?>" required title="Introduzca el precio del producto" <?php if(isset($code) && $code == 3){ echo "autofocus"; } ?> />
					</div>
					<div class="divisor_resp"></div>
					<input type="hidden" value="<?php echo $resultm['codigo_herramienta'] ?>" name="codigo_herramienta" id="codigo_herramienta" />
